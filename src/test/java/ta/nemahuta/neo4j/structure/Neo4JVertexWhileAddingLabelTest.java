...
public class Neo4JVertexWhileAddingLabelTest {
    ...
    public void givenLabelShouldAddItToVertex() {
        ...
        Assert.assertArrayEquals("Invalid vertex orLabelsAnd", vertex.labels(), new String[]{"A", "l1"});
    ...
    public void givenExistingLabelShouldNotModifyVertex() {
        ...
        Assert.assertArrayEquals("Invalid vertex orLabelsAnd", vertex.labels(), new String[]{"l1"});
    ...
    public void givenLabelInPartitionShouldThrowException() {
        ...
        // assert
        Assert.fail("Failed to detect label in readPartition");
    }
}
