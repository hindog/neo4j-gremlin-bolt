...
import ta.nemahuta.neo4j.handler.Neo4JDatabaseCommand;
...
public class Neo4JVertexWhileCreatingUpdateCommandTest {
    ...
    public void givenNewPropertyShouldCreateUpdateCommand() {
        ...
        Assert.assertEquals("Invalid update command statement", command.getStatement().text(), "MATCH (v:`l1`) WHERE n.whereId = {whereId} SET v = {vp}");
        Assert.assertEquals("Invalid update command statement", command.getStatement().parameters(), Values.parameters("whereId", 1L, "vp", Values.parameters("key1", "value1", "key2", "value2", "whereId", 1L)));
    ...
    public void givenNewLabelShouldCreateUpdateCommand() {
        ...
        Assert.assertNotNull("Failed to create update command", command);
        Assert.assertNotNull("Failed to create update command statement", command.getStatement());
        Assert.assertEquals("Invalid update command statement", command.getStatement().text(), "MATCH (v:`l1`) WHERE n.whereId = {whereId} SET v:`Test`");
        Assert.assertEquals("Invalid update command statement", command.getStatement().parameters(), Values.parameters("whereId", 1L));
        Assert.assertNotNull("Failed to create update command callback", command.getCallback());
        // invoke callback
        command.getCallback().accept(statementResult);
    }
    ...
    public void givenRemoveLabelShouldCreateUpdateCommand() {
        ...
        Assert.assertNotNull("Failed to create update command", command);
        Assert.assertNotNull("Failed to create update command statement", command.getStatement());
        Assert.assertEquals("Invalid update command statement", command.getStatement().text(), "MATCH (v:`l1`:`l2`) WHERE n.whereId = {whereId} REMOVE v:`l2`");
        Assert.assertEquals("Invalid update command statement", command.getStatement().parameters(), Values.parameters("whereId", 1L));
        Assert.assertNotNull("Failed to create update command callback", command.getCallback());
        // invoke callback
        command.getCallback().accept(statementResult);
    ...
    public void givenRemovePropertyShouldCreateUpdateCommand() {
        ...
        Assert.assertNotNull("Failed to create update command statement", command.getStatement());
        Assert.assertEquals("Invalid update command statement", command.getStatement().text(), "MATCH (v:`l1`) WHERE n.whereId = {whereId} SET v = {vp}");
        Assert.assertEquals("Invalid update command statement", command.getStatement().parameters(), Values.parameters("whereId", 1L, "vp", Values.parameters("key1", null, "whereId", 1L)));
        Assert.assertNotNull("Failed to create update command callback", command.getCallback());
        // invoke callback
        command.getCallback().accept(statementResult);
    }
