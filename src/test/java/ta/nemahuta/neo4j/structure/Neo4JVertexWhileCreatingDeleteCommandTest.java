...
public class Neo4JVertexWhileCreatingDeleteCommandTest {
    ...
    public void givenDeletedVertexNodeShouldCreateDeleteCommand() {
        ...
        Assert.assertEquals("Invalid delete command statement", command.getStatement().text(), "MATCH (v:`l1`) WHERE n.whereId = {whereId} DETACH DELETE v");
        Assert.assertEquals("Invalid delete command statement", command.getStatement().parameters(), Values.parameters("whereId", 1L));
