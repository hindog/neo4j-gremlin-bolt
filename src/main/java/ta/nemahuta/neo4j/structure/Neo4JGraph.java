...
import ta.nemahuta.neo4j.session.scope.DefaultNeo4JElementStateScope;
import ta.nemahuta.neo4j.session.scope.Neo4JElementStateScope;
import ta.nemahuta.neo4j.session.sync.Neo4JEdgeStateHandler;
import ta.nemahuta.neo4j.session.sync.Neo4JVertexStateHandler;
